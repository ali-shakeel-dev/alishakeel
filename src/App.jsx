  ...
  return (
    ...
    <SmoothScrollbar>
      <>
        ...
        <i id='burgerIcon' className='hidden bx bx-down-arrow-alt' onClick={handleNav}></i>
        ...
        <div id="second" className='max-w-[1700px] px-4 m-auto py-[6em]'>
          ...
          <a href="https://mind-flow.netlify.app/" target='_blank'>
          ...
          <a href="https://ali-shakeel-dev.github.io/hyphan/" target='_blank'>
            <div className="elem border-t border-gray-800 py-20">
          ...
          <a href="https://ali-shakeel-dev.github.io/saas-design/" target='_blank'>
          ...
          <a href="https://github.com/ali-shakeel-dev/youtube-auto-pause" target='_blank'>
            <div className="elem elemlast border-t border-gray-800 py-20">
        ...
        {/* CTA */}
        <div className="aboutContent max-w-[1700px] px-4 py-[6em] m-auto flex items-center justify-between max-[1420px]:items-start max-[1420px]:flex-col gap-4" >

          <div className="ctaContent flex relative">
            <img src="./favicon.png" alt="Ali Shakeel | Web Developer" className='w-[5rem] object-cover absolute max-[1000px]:top-[-2rem]' />
            <h2 className='text-7xl max-[1000px]:text-5xl max-[1000px]:w-full leading-normal w-[65rem] indent-24'>
              Let’s talk about a project, collaboration or an idea you may have.
            </h2>
          </div>
          <div className="ctaButton flex items-end">
            <Button href="mailto:muhammadalishakeel66@gmail.com" btnVal='Drop me a line' />
          </div>
        </div>
        ...
        <div className='max-w-[1700px] max-[1000px]:flex-col max-[1000px]:gap-4 max-[1700px]:text-center px-4 m-auto py-10 flex items-center justify-between text-2xl '>
          <div>
            <p>© 2024 - All Rights Reserved. Coded with ❤️️</p>
          </div>
